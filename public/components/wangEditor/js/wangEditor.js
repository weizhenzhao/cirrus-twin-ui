...
_e(function (E, $) {
    ...
    E.createMenu(function (check) {
        ...
        var $linkInput = $('<input type="text" class="block" placeholder=\'Pattern：<iframe src="..." frameborder=0 allowfullscreen></iframe>\'/>');
        ...
        var $howToCopy = $('<a href="http://www.kancloud.cn/wangfupeng/wangeditor2/134973" target="_blank" style="display:inline-block;margin-top:10px;margin-left:10px;color:#999;">how to copy video link ?</a>');
        var $btnSubmit = $('<button class="right">' + lang.submit + '</button>');
        var $btnCancel = $('<button class="right gray">' + lang.cancel + '</button>');
...
_e(function (E, $) {
    ...
    E.plugin(function () {
        ...
        editor.xhrUploadImg = function (opt) {
            ...
            // ------------ begin 预览模拟上传 ------------Bryan
            if (!E.isOnWebsite||E.isOnWebsite) {
                E.log('预览模拟上传');
