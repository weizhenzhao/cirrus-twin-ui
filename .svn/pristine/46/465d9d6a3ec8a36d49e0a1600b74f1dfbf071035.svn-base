...
module.exports = {
  init: function (options) {
    options = options || {}
    this.clientId = options.clientId || 'AuthClient';
    this.serverUrl = options.serverUrl || 'https://879c5fe8-0650-428e-b529-40d4f3e3ae43.predix-uaa.run.aws-usw02-pr.ice.predix.io';
    this.accessToken = null;
    this.defaultClientRoute = options.defaultClientRoute || '/';
    this.base64ClientCredential = options.base64ClientCredential || 'QXV0aENsaWVudDpxTjkxMTIkNW9CcXk=';
    this.user = null;
