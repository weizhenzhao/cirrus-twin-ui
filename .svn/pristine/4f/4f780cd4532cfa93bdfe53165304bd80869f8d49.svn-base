(function (window) {
    ...
    // 音量识别
    var volume= new (window.AudioContext || window.webkitAudioContext || window.mozAudioContext)
    volume.analyser = volume.createAnalyser();
    var datas =new Uint8Array(volume.analyser.frequencyBinCount);
